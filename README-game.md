...
## 🕹️ `ACT VIII` — PLAY THE GAME

> [!IMPORTANT]
> **This profile is playable.** Open an issue and you're in the dungeon.
> The bot reads your choice, renders the next room, and closes the issue when
> your run ends. No account setup, no download, one click.
